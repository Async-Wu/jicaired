 ...
 */
public class BasketballSFCSelector extends BaseActivity {
    ...
    private void initData() {
        ...
        selectedArray = mManager.selectedLotteryGameArray.get(202);
    }
    ...
    private void setupListsner() {
        visitGridView.setOnItemClickListener(new OnItemClickListener() {
...
if (isClick){
        ...
        hostGridView.setOnItemClickListener(new OnItemClickListener() {
        ...
        ensureBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (count == 0) {
                    oneGame.reset();
                    mManager.selectedLotteryGameArray.get(202).remove(oneGame.orderIdLocal);
                } else {
                    oneGame.isDanPressed = false;
                    mManager.selectedLotteryGameArray.get(202).put(oneGame.orderIdLocal, oneGame);
                }
                setResult(10);
                finish();
