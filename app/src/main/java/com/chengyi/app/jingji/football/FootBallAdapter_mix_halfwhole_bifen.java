...
public class  FootBallAdapter_mix_halfwhole_bifen extends FootballAdapterBase {
    Button btn;
    boolean isSelected;
    int flag;// /判断标志
    int wfindex;
    ...
    public FootBallAdapter_mix_halfwhole_bifen(Activity mActivity,  SparseArray<JingcaizuqiuOneGame> gameList, OnGameTouchCallback handler) {
    ...
    public View getChildView(int groupPosition, int childPosition,
        ...
        if (convertView == null) {
            ...
            if (wfindex == 3)
                convertView = inflater.inflate(R.layout.fragment_lottery_football_listview_mix, parent,false);
            else
                convertView = inflater.inflate(R.layout.fragment_lottery_football_listview_bifen, parent,false);
        ...
        if (wfindex != 3) {
            holder.touzhulayout.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
    ...
    class ChildViewHolder {
        ...
        LinearLayout leftlayout, layoutbottom, touzhulayout;
        ...
        public void loadViews(View convertView) {
            ...
            if (wfindex == 3) {
                ...
                touzhulayout = (LinearLayout) convertView.findViewById(R.id.touzhulayout);
            }
            leftlayout = (LinearLayout) convertView.findViewById(R.id.leftlayout);
        ...
        public void fill(JingcaizuqiuOneGame game) {
            ...
            if (wfindex == 3) {
                ...
                if (!TextUtils.isEmpty(game.getSelContentStr())) {


                    chosedtext.setText(game.getSelContentStr());
                    touzhulayout.setSelected(true);
                } else {
                    chosedtext.setText("点击展开比分投注区");
                    touzhulayout.setSelected(false);
                }
            }
