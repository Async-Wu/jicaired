 ...
 */
@Deprecated
public class  BasketballPreviousRecord extends BaseActivity implements OnScrollListener, OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_basketball_previous_record);
        ...
        list = new ArrayList<JingCaiFootBallKaiJiangData>();
